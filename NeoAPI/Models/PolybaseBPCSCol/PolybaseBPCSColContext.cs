...
public partial class PolybaseBPCSColContext : DbContext
{
    public PolybaseBPCSColContext()
    {
    }

    public PolybaseBPCSColContext(DbContextOptions<PolybaseBPCSColContext> options)
        : base(options)
    {
