...
public partial class Entradaejecucion
{
    ...
    public virtual Personal? CodigosupervisorNavigation { get; set; }

    public virtual Tuplaejecucion? CodigotuplaNavigation { get; set; }

    public virtual Tiposdeturno? CodigoturnoNavigation { get; set; }
