...
public partial class PolybaseBPCSCenContext : DbContext
{
    public PolybaseBPCSCenContext()
    {
    }

    public PolybaseBPCSCenContext(DbContextOptions<PolybaseBPCSCenContext> options)
        : base(options)
    {
